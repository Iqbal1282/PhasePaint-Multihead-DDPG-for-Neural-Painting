...
class MoEDDPG:
    ...
    def __init__(self, num_experts=3, sigma=0.35,
                 ...
                 writer=None, resume=None, output_path=None, spatial_grid=4, spatial_alpha=0.3,
        ...
        # ── Spatial progress bonus ────────────────────────────────────────────
        self.spatial_bonus = SpatialProgressBonus(
            grid_k= spatial_grid, alpha= spatial_alpha)
    ...
    def update_policy(self, lr):
        ...
        target_q = target_q + step_reward.detach() + reward.view(-1, 1)
